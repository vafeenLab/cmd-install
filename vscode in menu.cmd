...
SET PATH=C:\Program Files\Microsoft VS Code\Code.exe

echo Adding file entries
@reg add "HKEY_CLASSES_ROOT\*\shell\VSCode" /t REG_SZ /v "" /d "Open VSCode here"  /f
...
@reg add "HKEY_CLASSES_ROOT\Directory\Background\shell\VSCode" /t REG_SZ /v "" /d "Open VSCode here"  /f
...
@reg add "HKEY_CLASSES_ROOT\Directory\shell\VSCode" /t REG_SZ /v "" /d "Open VSCode here"  /f
