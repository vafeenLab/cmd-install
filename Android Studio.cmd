...
reg add "HKEY_CLASSES_ROOT\*\shell\AndroidStudio" /t REG_SZ /v "Icon" /d "%AndroidStudioPath%,0" /f
...
reg add "HKEY_CLASSES_ROOT\Directory\Background\shell\AndroidStudio" /t REG_SZ /v "Icon" /d "%AndroidStudioPath%,0" /f
...
reg add "HKEY_CLASSES_ROOT\Directory\shell\AndroidStudio" /t REG_SZ /v "Icon" /d "%AndroidStudioPath%,0" /f
